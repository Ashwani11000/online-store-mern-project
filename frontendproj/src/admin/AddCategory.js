...
const AddCategory = () =>{
    ...
    const goBack=()=>(
        <div className="mt-5">
            <Link className="btn btn-sm btn-info mb-3" to="/admin/dashboard">Admin Panel</Link>
        </div>
    );
    ...
    return (
        <Base title="Create a new category here."  description="Add a new category here." className="container bg-info p-4">
